...
const ServiceDetail = () => {
    ...
    if (error) return <div className="z-service-detail-state z-service-detail-error">{error}</div>;
                    ...
                    <div className="z-service-detail-layout">
                            ...
                            {images.length > 1 && (
                                <div className="z-service-detail-thumb-list">
                                    {images.map((img, index) => (
                                        <div 
                                            key={index} 
                                            className={`z-service-detail-thumb-item ${activeImage === index ? 'active' : ''}`}
                        ...
                        <div className="z-service-detail-right">
                            ...
                            <div className="z-service-detail-actions">
                                ...
                                <button className="z-service-detail-btn-primary" onClick={handleEditClick}>
